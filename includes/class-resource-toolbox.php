...
class Resource_Toolbox {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Resource_Toolbox_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'resource-toolbox';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Resource_Toolbox_Loader. Orchestrates the hooks of the plugin.
	 * - Resource_Toolbox_i18n. Defines internationalization functionality.
	 * - Resource_Toolbox_Admin. Defines all hooks for the admin area.
	 * - Resource_Toolbox_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-resource-toolbox-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-resource-toolbox-i18n.php';
		 ...
		 * The class responsible for defining resource metaboxes.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-resource-toolbox-settings.php';
	 ...
	 *
	 * Uses the Resource_Toolbox_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Resource_Toolbox_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Resource_Toolbox_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Resource_Toolbox_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Resource_Toolbox_Loader    Orchestrates the hooks of the plugin.
	 */
